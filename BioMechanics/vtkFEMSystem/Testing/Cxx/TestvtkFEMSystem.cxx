...
int main(int argc, char * argv[])
{
  ...
  vtkFEMSystem* FEMSystem = vtkFEMSystem::New();
  FEMSystem->SetInput(mesh);
  FEMSystem->SetSpringCoefficient(200);
  FEMSystem->SetDistanceCoefficient(10);
  FEMSystem->SetDampingCoefficient(1.5);//Friction
  ...
  FEMSystem->SetContacts(list, directions);
  ...
  mapper2->SetInput(FEMSystem->GetOutput());
  ...
  //Create a faster timer for FEM update
