#ifndef __UGridAcceleratorMSS_h__
#define __UGridAcceleratorMSS_h__
...
class UGridAcceleratorMSS {
public:
    UGridAcceleratorMSS(void);
    UGridAcceleratorMSS(vtkUnstructuredGrid* grid);
    ~UGridAcceleratorMSS(void);
